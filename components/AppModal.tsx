      ...
      <div className="modal-box app-modal-box" ref={boxRef}>
        ...
        {!transitioning && step === 1 && (
          <div className="step-panel active">
            <h2 className="sp-title">Informations personnelles</h2>
            <p className="sp-sub">
              Complétez votre profil pour que notre équipe puisse étudier votre dossier.
            </p>

            <div className="sum-box">
              <div className="sum-box-title">Récapitulatif du prêt souhaité</div>
            ...
            <button className="btn-full" onClick={() => goToStep(2)}>
              Continuer →
            </button>
          </div>
        )}
